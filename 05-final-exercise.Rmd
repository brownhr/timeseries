...
knit: (function(input, ...){
  rmarkdown::render(input, output_format = "bookdown::word_document2", output_options = list(number_sections = FALSE))
  })
---
...
# Data is already pre-processed as a `zoo` object. It contains missing values, so
